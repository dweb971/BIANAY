            ...
            <div class="card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="traitement.php" class="needs-validation" novalidate>
                        <div class="form-row">
                            <div class="name">Civilité:<span
                        class="obj">(*)</span></label></div>
                            <div class="value">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="civ" required>
                                            ...
                                            <option value="monsieur">Choisissez votre civilité :</option>
                        ...
                        <div class="form-row">
                            <div class="name">Téléphone:<span
                        class="obj">(*)</span></label></div>
                            <div class="value">
                                <div class="row row-refine">
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="tel" maxlength="15" required>
                                            <div class="valid-feedback">
                                                Champ correct!
                                            </div>
                                            <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="name">Adresse 2</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="adresse 2">
                                    <div class="valid-feedback">
                                        Champ correct!
                                    </div>
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="codepostal" maxlength="5">
                                    <div class="valid-feedback">
                                        Champ correct!
                                    </div>
                                </div>
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="pays">
                                            ...
                                            <option value="choisissez votre pays :">Choisissez votre pays :</option>
